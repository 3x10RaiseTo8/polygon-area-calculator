...
The Square class is able to access the Rectangle class methods and it also contain a `set_side` method. If an instance of a Square is represented as a string, it looks like: `Square(side=9)`
